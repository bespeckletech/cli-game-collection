...
// Stop stops the view
func (view *View) Stop() {
	log.Println("View Stop start")

	screen.Fini()

	log.Println("View Stop end")
}
...
func (view *View) ShowGameOverAnimation() {
	log.Println("View ShowGameOverAnimation start")

	switch rand.Intn(3) {
	case 0:
		log.Println("View ShowGameOverAnimation case 0")
	...
	case 1:
		log.Println("View ShowGameOverAnimation case 1")
	...
	case 2:
		log.Println("View ShowGameOverAnimation case 2")
	...
	log.Println("View ShowGameOverAnimation end")
}
